...
set MKL_PATH=C:\Program Files (x86)\Intel\oneAPI\mkl\2022.1.0
set DNNL_PATH=C:\Users\cenam\Documents\Builds\dnnl_win_2.6.0_cpu_vcomp_gpu_vcomp\dnnl_win_2.6.0_cpu_vcomp_gpu_vcomp
set OPENCL_LIB_PATH=C:\Program Files (x86)\IntelSWTools\system_studio_2020\OpenCL\sdk\lib\x64
set OPENCL_INCLUDE_PATH=C:\Program Files (x86)\IntelSWTools\system_studio_2020\OpenCL\sdk\include
set ONNX_PATH=C:\Users\cenam\Microsoft.ML.OnnxRuntime.DirectML.1.14.0-dev-20230209-0844-6ccaeddefa
...
-Donednn=false -Ddnnl=true -Dmkl_include="%MKL_PATH%\include" -Dmkl_libdirs="%MKL_PATH%\lib\intel64" -Ddnnl_dir="%DNNL_PATH%" ^
